          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: AppBar(
                ...
                title: Text("Save 2 Gold",style: commonstylepoppins(size: 18,weight: FontWeight.w500),),
                centerTitle: true,
                actions: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                            ...
                            child: Row(
                              ...
                              children:[
                                Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children:[
                                    Text("Total period",style:commonstylepoppins(size: 12,weight: FontWeight.w300)),
                                    Spantxt2("12", " (months)", commonstylepoppins(size: 14,weight: FontWeight.w500), commonstylepoppins(size: 8,color: Color(0xFF7C7976),weight: FontWeight.w400))
                                ...
                                Column(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children:[
                                      Text("Total value",style:commonstylepoppins(size: 12,weight: FontWeight.w300)),
                                      Text("60,000/-",style: commonstylepoppins(size: 12,weight: FontWeight.w500),)
                                ...
                                Column(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children:[
                                      Text("Net weight",style:commonstylepoppins(size: 12,weight: FontWeight.w300)),
                                      Spantxt2("9.56g", " (expected)", commonstylepoppins(size: 14,weight: FontWeight.w500), commonstylepoppins(size: 8,color: Color(0xFF7C7976),weight: FontWeight.w400))
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Spantxt2("150", " /day", commonstylepoppins(size: 15,weight: FontWeight.w500), commonstylepoppins(size: 15,color: Color(0xFFA6A6A6),weight: FontWeight.w500))
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Center(child: Text("Join now",style: commonstylepoppins(size: 10,weight: FontWeight.w600),)),
                                  ),
                                ),
